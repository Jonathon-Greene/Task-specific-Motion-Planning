function [conv_status,counter,new_pose,joint_angles] = chap3_svm( temp21,theta1, g_st1, DualQuaternion1 )
...
%}
            ...
            %% Check if EE can reach position in workspace
            [status] = check_within_workspace(temp21);
            if status == 1 % Given pose is within the workspace
    ...
    %                         Table01(grid_x,grid_y,grid_theta) = true;
            ...
            elseif status == 2 % Given pose is out of workspace
                conv_status = false;
                counter = -1;
