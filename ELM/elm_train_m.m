function [TrainingTime,TrainingAccuracy] = elm_train_m(TrainingData_matrix, Elm_Type, NumberofHiddenNeurons, ActivationFunction, filename)
...
train_data = TrainingData_matrix;
T=train_data(:,1)';
...
if Elm_Type~=REGRESSION
    save(filename,'NumberofInputNeurons', 'NumberofOutputNeurons', 'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'label', 'Elm_Type');
else
    save(filename,'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'Elm_Type');    
end